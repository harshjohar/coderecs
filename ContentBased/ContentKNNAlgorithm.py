...
'''
Div1 A == Div2 C
Div1 A in problems.csv
Div2 C not in problems.csv
'''
class ContentKNNAlgorithm(AlgoBase):
    ...
    def fit(self, trainset):
        ...
        self.similarities = {}
        # df = pd.read_csv('/Users/harshjohar/Documents/WebProjects/coding-platform-deep-learning/scripts/ProblemDataCollection/problems.csv')
        # a = df['id'].unique()
    ...
    def computeGenreSimilarity(self, movie1, movie2, genres):
        ...
        # print("genres", genres)
        # print(genres1, genres2)
        # if (len(genres1) != len(genres2)):
        #     print(len(genres1), len(genres2))
            # print(movie1, movie2)
            # return 0
